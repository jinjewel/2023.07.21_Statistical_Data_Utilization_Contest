...
##################################################################################
## 전체 데이터
sea_surface_temp = read_excel("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\해수면온도데이터\\해수면온도데이터.xlsx")
## 데이터프레임으로 변경
...
### 온난화로 인한 갑자기 수온이 상승한 년도부터 수온 변화 예측
## 데이터 설정 
x <- ts(korea_Watch_Zone_temp$우리나라.주변.해수면_온도[85:114])
x11()
tsdisplay(x)
## 로그변환 설정
lx <- log(x)
...
# 사용 불가
# 계절성 아리마
fit2 <- arima(lx, order=c(0,1,1),seasonal = list(order=c(0,1,1),periods=12))
summary(fit2)
## p,d,q가 (1,1,0)*(0,1,3)12 이다.
coeftest(fit2)
confint(fit2)
...
fc$mean 
################################################################
### 온난화로 인한 갑자기 수온이 상승한 년도부터 수온의 편차 변화 예측
## 데이터 설정 
x <- ts(ellinyo_Watch_Zone_Devi_temp$엘니뇨.감시구역_편차[85:114])
x11()
tsdisplay(x)
## 로그변환 설정
lx <- x
...
# 사용 불가
# 계절성 아리마
fit2 <- arima(lx, order=c(0,1,2),seasonal = list(order=c(1,1,0),periods=12))
summary(fit2)
## p,d,q가 (1,1,0)*(0,1,3)12 이다.
coeftest(fit2)
confint(fit2)
...
data_2014 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2015 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2016 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2017 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2018 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2019 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2020 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
data_2021 = read.csv("C:\\Users\\CBNU\\Desktop\\3인 공모전\\데이터\\기상관측데이터\\2014_total_data.csv", fileEncoding = "euc-kr")
...
data_2014[is.na(data_2015)] <- 0
data_2014[is.na(data_2016)] <- 0
data_2014[is.na(data_2017)] <- 0
data_2014[is.na(data_2018)] <- 0
data_2014[is.na(data_2019)] <- 0
data_2014[is.na(data_2020)] <- 0
data_2014[is.na(data_2021)] <- 0
sum(data_2014$Day_preci[1:365])
