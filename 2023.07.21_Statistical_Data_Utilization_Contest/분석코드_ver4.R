...
## 전체 데이터
sea_surface_temp = read_excel("C:\\Users\\CBNU\\Desktop\\수정한데이터\\해수면온도데이터.xlsx")
...
plot(ellinyo_Watch_Zone_temp$number, ellinyo_Watch_Zone_temp$엘니뇨.감시구역_온도, 
     type="l", ylab="엘니뇨 감시구역 온도", main="엘니뇨 감시구역 온도")
fit1 <- hw(ellinyo_Watch_Zone_temp$엘니뇨.감시구역_온도, seasonal="additive", h=12)
fit2 <- hw(ellinyo_Watch_Zone_temp$엘니뇨.감시구역_온도, seasonal="multiplicative", h=12)
